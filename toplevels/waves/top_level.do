...
add wave -noupdate -radix binary /tb_top_level/DUT/rx/byte_reg
add wave -noupdate /tb_top_level/DUT/rx/byte_reg
...
add wave -noupdate -radix binary /tb_top_level/encoded_byte
add wave -noupdate /tb_top_level/databyte
...
add wave -noupdate -divider db
add wave -noupdate /tb_top_level/DUT/buffer/curr_reg
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2820274 ps} 0}
...
update
WaveRestoreZoom {646800 ps} {3880800 ps}
