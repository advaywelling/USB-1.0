...
add wave -noupdate -color Cyan /tb_top_level/dp_out
add wave -noupdate -color Cyan /tb_top_level/dm_out
add wave -noupdate /tb_top_level/DUT/transmitter/tx_transfer_active
add wave -noupdate /tb_top_level/DUT/transmitter/tx_error
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {7359141 ps} 0}
